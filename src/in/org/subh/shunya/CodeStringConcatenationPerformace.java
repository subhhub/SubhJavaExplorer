 ...
 * 
 */
public class CodeStringConcatenationPerformace {
	...
	public static void main(String[] args) {
		...
		// Using String concat() method startTime = System.nanoTime()
		for (int i = 0; i < ITERATION; i++) {
		...
		StringBuffer buffer = new StringBuffer(); 			// default size 16 startTime = System.nanoTime()
		for (int i = 0; i < ITERATION; i++) {
			buffer.append(i);
		}
		...
		StringBuilder builder = new StringBuilder(); 		// default size for worst case startTime = System.nanoTime()
		for (int i = 0; i < ITERATION; i++) {
			builder.append(i);
		}
