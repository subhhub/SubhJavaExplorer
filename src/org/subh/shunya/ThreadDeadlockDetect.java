...
class SharedDetect {
	synchronized void methodOne(SharedDetect s) {
	...
	synchronized void methodTwo(SharedDetect s) {
		Thread t = Thread.currentThread();
...
public class ThreadDeadlockDetect {
	
	public static void main(String[] args) {
		
		final SharedDetect s1 = new SharedDetect();
		final SharedDetect s2 = new SharedDetect();
